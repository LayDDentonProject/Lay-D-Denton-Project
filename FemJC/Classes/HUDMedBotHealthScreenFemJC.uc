//=============================================================================
// HUDMedBotHealthScreenFemJC
//=============================================================================
class HUDMedBotHealthScreenFemJC extends PersonaScreenHealthFemJC;
...
event InitWindow()
{
	...
	HUDMedBotNavBarWindowFemJC(winNavBar).btnHealth.SetSensitivity(False);
...
{
	winNavBar = PersonaNavBarBaseWindow(NewChild(Class'HUDMedBotNavBarWindowFemJC')); 
...
{
	winOverlays = PersonaOverlaysWindow(winClient.NewChild(Class'HUDMedBotHealthOverlaysWindowFemJC'));
