//=============================================================================
// HUDMedBotAddAugsScreenFemJC
//=============================================================================
class HUDMedBotAddAugsScreenFemJC extends PersonaScreenAugmentationsFemJC;
...
event InitWindow()
{
	...
	HUDMedBotNavBarWindowFemJC(winNavBar).btnAugs.SetSensitivity(False);
...
{
	winNavBar = PersonaNavBarWindowFemJC(NewChild(Class'HUDMedBotNavBarWindowFemJC')); 
